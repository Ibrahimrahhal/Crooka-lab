        ...
        <View style={styles.container}>
          ...
          <View style={styles.buttomWordContainer}>
            ...
            <Text style={styles.arabText} h5>
              كروكا لاب تطبيع يمكنك من القيام بتبليغ عن حوادث السير تلقائيا
              والحصول على تقرير الكروكا الكترونيا بدون اي حاجه الي تضيع الوقت
              والجهد في حالة الحوادث الصغيره
            </Text>
            <Button
              title="إبدا الجولة بالتطبيق"
