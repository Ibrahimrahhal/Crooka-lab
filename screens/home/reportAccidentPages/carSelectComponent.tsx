        ...
        <TouchableWithoutFeedback
          ...
          onPress={(event) => {
            ...
            let cancel: any = this.props.points.find((point: any) => {
              return (
                x - getPointDim() <
                  (true ? point.locationX : point.locationY) &&
                (true ? point.locationX : point.locationY) <
                  x + getPointDim() &&
                y - getPointDim() <
                  (false ? point.locationX : point.locationY) &&
              ...
              {this.props.points.map((point: any) => {
                return (
                  <A_View
                    ...
                    style={{
                      ...styles.point,
                      top: point.locationY - getPointDim() / 2 || 0,
                      right: point.locationX - getPointDim() / 2 || 0,
                    }}
                  >
                    <TouchableOpacity
                      style={styles.btnInnterContainer}
                      onPress={(event) => {
