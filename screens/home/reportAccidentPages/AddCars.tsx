...
class AddCars extends Component<any, any> {
  ...
  isCarsEmpty = () => {
    if (this.state.isButtonClicked) return true;
      ...
      <Fragment>
        <ScrollView>
          <View>
            ...
            <View style={styles.upperContainer}>
              ...
              <View style={styles.textContainer}>
                <Text h5 style={styles.text}>
                  لتقوم بالتبليغ عن الحادث بشكل صحيح يجب عليك ان تقوم بادخال
                  بيانات المركبات واحدة تلو الاخره
                </Text>
              </View>
            </View>
            <View style={{}}>
              ...
              <Text h5 style={{ ...styles.text, paddingLeft: "3%" }}>
                لا يوجد اي مركبة متضمنة بالحادث يجب على الحادث ان يتضمن مركبتين
                على الاقل لاضافة مركبقة قم بالضغط على زر الاضافة
              </Text>
              <Button
                long
                title="اضافة مركبة"
            ...
            <View>
              {(this.props.accident?.involvedCars || []).map(
                (item: { car: Car }) => {
                  return (
                    <View
                      style={styles.itemContainer}
                      key={item.car.platNumber}
                    >
                      <Text bold>{item.car.platNumber}</Text>
                      <Image
                        source={
                          carTypes.find((itemX) => itemX.name == item.car.type)
                            ?.img
                        }
                        resizeMode={"contain"}
            ...
            <View>
              ...
              >
                <Button
                  long
                  disabled={
                    !((this.props.accident?.involvedCars || []).length > 1)
                  }
                  title="تسجيل الحادث"
                  onPress={() => {
          ...
          <View style={styles.buttonsBottom}>
            ...
            >
              <Button
                ...
                containerStyle={{ ...styles.addButtonContainer, width: "70%" }}
                buttonStyle={styles.addButtonStyle}
                titleStyle={styles.addButtonText}
              />
            </View>
