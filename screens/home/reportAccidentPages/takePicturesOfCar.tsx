    ...
    return (
      <View style={styles.mainContainer}>
        ...
        <Text style={styles.TextMain}>
          ...
          sodales, augue vitae gravida gravida, ex est auctor lectus, sed
          commodo leo leo quis dolor.
        </Text>
        ...
        <CameraModal
          visible={this.state.openCameraModel}
          onShot={(photo) => {
            ...
            this.setState({
              ...this.state,
              activeCarSide: carSides.find(
                (x) => x.ID == this.state.activeCarSide
              )?.next,
              openCameraModel: false,
            });
          }}
