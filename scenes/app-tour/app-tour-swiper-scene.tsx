            ...
            <Animatable.View style={styles.slideContainer} animation={"fadeIn"}>
              ...
              <View style={styles.secondHalf}>
                ...
                <Text h5 style={{ ...styles.text, ...styles.smallText }}>
                  عند وقوع اي حادث سير بسيط يمكنك البدآ بفتح التطبيق والابلاغ عن
                  الحادث عن طريق ادخال بيانات المركبات٫ التقاط بعض الصور ويتنهى
                  الامر بوصول تقرير الكروكا لكلا الطرفين
                </Text>
              </View>
            </Animatable.View>
          </NgIf>
          ...
          <NgIf if={visitedArray[1]}>
            <Animatable.View style={styles.slideContainer} animation={"fadeIn"}>
              ...
              <View style={styles.secondHalf}>
                ...
                <Text h5 style={{ ...styles.text, ...styles.smallText }}>
                  لكي تكمل العملية يجب عليك القيام بتعبئة بيانات اساسية عن
                  الحادث واطرافة مع التقاط صور مجموعة من الوثائق مثل رخصة
                  القياده ورحصة السياره وايضا صور للمركبات المتضرره
                </Text>
              </View>
            </Animatable.View>
          </NgIf>
          ...
          <NgIf if={visitedArray[2 - slideShouldActivate]}>
            <Animatable.View style={styles.slideContainer} animation={"fadeIn"}>
              ...
              <View style={styles.secondHalf}>
                ...
                <Text h5 style={{ ...styles.text, ...styles.smallText }}>
                  بعد تقديم البيانات والصور المطلوبة يتبقى عليك فقط الانتظار
                  ليتم مراجعتها وبعدها فورا سيتم ارسال تقرير الكوركا برسالة لكل
                  اطراف الحادث
                </Text>
                <Button
